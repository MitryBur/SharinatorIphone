//
//  DBExpenseDebtorsVC.m
//  Sharinator-iPhone
//
//  Created by Dmitry Burmistrov on 16/03/14.
...
@interface DBExpenseDebtorsVC ()

@end

@implementation DBExpenseDebtorsVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ShariUser *user = self.debtors[indexPath.row];
